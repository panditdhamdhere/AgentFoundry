...
export function RegisterContent({ isGated, hasAccess, hasCode }: RegisterContentProps) {
  const [verified, setVerified] = useState(hasAccess);
  const { isConnected } = useAccount();

  const showForm = !isGated || verified;
        ...
        <div className="mx-auto max-w-md">
          <div className="page-header">
            ...
            <p className="page-description">
              Registration is currently in private beta.
              {hasCode
          ...
          {hasCode ? (
            <BetaGate onVerified={() => setVerified(true)} />
          ) : (
            <div className="card-base p-10 text-center">
              ...
              <h2 className="prose-heading text-lg font-semibold text-zinc-100">
                Invite Only
              </h2>
              <p className="mt-3 text-sm text-zinc-500">
                Beta registration is closed. Join the waitlist to be notified when we open access.
              </p>
              <Link
                href="/#join-beta"
